<?php 
	require "view/layout/head-out-tour.php";
?>
<!-- Home -->
...
<div class="home">
	...
	<?php
		$banner = banner_select_loaitour_2();
		foreach ($banner as $value) {
			extract($value);
			echo "	<div class='home_background parallax-window' data-parallax='scroll' data-image-src='$Hinh_anh' data-speed='0.8'></div>
			";}
	?>
	<!-- <div class="home_background parallax-window" data-parallax="scroll" data-image-src="view/images/offers.jpg" data-speed="0.8"></div> -->
	<div class="container">
		<div class="row">
			<div class="col">
				<div class="home_content">
					<div class="home_content_inner">
						<div class="home_title">Tour trong nước</div>
						<div class="home_breadcrumbs">
							<ul class="home_breadcrumbs_list">
								<li class="home_breadcrumb"><a href="?page=index">Home</a></li>
								<li class="home_breadcrumb">Tour trong nước</li>
							</ul>
						</div>
					</div>
				</div>
...
<?php
		...
		?>
<?php 
	require "view/layout/footer-in-tour.php";
?>